...
public class Homework {
  ...
  /**
   * V 0. Переварить все, что было изучано.
   * V 1. Доделать сервис управления книгами:
   * V 1.1 Реализовать контроллер по управлению книгами с ручками:
   * V GET    /book/{id} - получить описание книги,
   * V DELETE /book/{id} - удалить книгу,
   * V POST   /book - создать книгу
   * V 1.2 Реализовать контроллер по управлению читателями (аналогично контроллеру с книгами из 1.1)
   * V 1.3 В контроллере IssueController добавить ресурс GET /issue/{id} - получить описание факта выдачи
   *
